      ...
      <div className="bg-kala-800/30 border-y border-kala-800 py-16">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <button onClick={onViewNews} className="mt-8 flex items-center gap-2 text-kala-secondary font-bold hover:gap-3 transition-all">
      ...
      <div className="max-w-7xl mx-auto px-6 py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <LoginCard 
            ...
            icon={Music} 
            desc="Manage your EPK, accept bookings, sell merch, and connect with venues." 
          />
          <LoginCard 
            role={UserRole.VENUE} 
            icon={Building2} 
            desc="Scout talent, manage event calendars, and handle ticketing logistics." 
          />
          <LoginCard 
            role={UserRole.REVELLER} 
            icon={Users} 
            desc="Buy tickets, collect NFTs, bid on auctions, and follow your favorite artists." 
          />
          <LoginCard 
            role={UserRole.ADMIN} 
            icon={ShieldCheck} 
            desc="Platform oversight, analytics, dispute resolution, and system configuration." 
          />
          <LoginCard 
            role={UserRole.DAO_MEMBER} 
            icon={Globe2} 
            desc="Vote on proposals, allocate grants, and govern the platform direction." 
          />
          <LoginCard 
            role={UserRole.SERVICE_PROVIDER} 
            icon={Users} 
            desc="Offer consultancy, legal, or production services to the community." 
          />
          <LoginCard 
            role={UserRole.ORGANIZER} 
            icon={Building2} 
            desc="Plan festivals, manage multi-artist lineups, and coordinate logistics." 
          />
           <LoginCard 
            role={UserRole.SPONSOR} 
            icon={Coins} 
            desc="Fund events, support artists, and gain brand visibility." 
          />
        </div>
      </div>
           ...
           <div className="bg-kala-900 border border-kala-700 rounded-2xl w-full max-w-lg overflow-hidden shadow-2xl relative">
              ...
              <div className="p-6 space-y-4">
                 ...
                 <div className="pt-4 border-t border-kala-800">
                    ...
                    <button 
                      onClick={() => { setShowMembersPreview(false); onJoin(); }}
